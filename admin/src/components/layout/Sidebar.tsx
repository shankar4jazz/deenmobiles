import { BarChart3, LayoutDashboard, Plus, Package, Shield, ShieldCheck, UserCog, Database, Wallet, Receipt, AlertCircle, ChevronDown, ChevronRight, Settings, ClipboardList } from 'lucide-react';
